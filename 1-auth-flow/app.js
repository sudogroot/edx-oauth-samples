...
const OIDC_BASE_URI = `http://localhost:18000/oauth2`;
  ...
  new OneLoginStrategy(
    {
      ...
      authorizationURL: `${OIDC_BASE_URI}/authorize`,
      userInfoURL: `${OIDC_BASE_URI}/user_info`,
      tokenURL: `${OIDC_BASE_URI}/access_token`,
